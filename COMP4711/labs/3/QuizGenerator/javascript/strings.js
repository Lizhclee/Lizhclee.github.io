...
const classAnswer = "adminAnswer";
const classAdminInput = "adminInput";
const classAdminInputAnswer = "answertext";
const classAdminTextPrompt = "adminText";
const classButton = "actionButton";
const classChoice = "choice";
const classCode = "code";
const classQuestion = "question";
const classRadio = "answer";
...
const quizAnswers = "choices";
const quizCode = "codesnippet";
const quizQuestion = "quest";
